---
layout: default
title: "Cursor AI Privacy Mode: How to Use AI Features Without Sending Code"
...
3. **Leverage multi-cursor editing**: Use Alt+Click for bulk edits
4. **Utilize workspace symbols**: Cmd/Ctrl+Shift+O for quick navigation
