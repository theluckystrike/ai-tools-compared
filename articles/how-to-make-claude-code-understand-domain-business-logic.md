...
- [How to Write Your First Custom Prompt with Claude Code](/claude-skills-guide/how-to-write-a-skill-md-file-for-claude-code/) — Custom prompts encode domain-specific behavior
