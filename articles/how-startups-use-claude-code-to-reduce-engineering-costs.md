...
[The **tdd** skill exemplifies this approach](/claude-skills-guide/automated-testing-pipeline-with-claude-tdd-skill-2026/) Instead of manually writing test cases, developers describe the function behavior and let Claude generate the tests:
...
[the **pdf** skill handles document processing without requiring custom code](/claude-skills-guide/best-claude-code-skills-to-install-first-2026/):
