...
- [Claude Code Webhook Handler Implementation Workflow Guide](/claude-skills-guide/claude-code-webhook-handler-implementation-workflow-guide/) — General webhook patterns covering provider-agnostic signature verification, idempotency utilities, and multi-provider setups (GitHub, Twilio, and more)
