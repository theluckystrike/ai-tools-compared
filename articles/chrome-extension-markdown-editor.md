...
1. Write in markdown using the extension
2. Export to HTML for web content
3. Copy rendered output for platforms like Medium
4. Save raw markdown for version control
