...
[The **deployment-helper** skill generates deployment scripts](/claude-skills-guide/claude-skills-with-github-actions-ci-cd-pipeline/) using Salesforce CLI or Ant migration tools. It creates package.xml files and validates components before deployment.
