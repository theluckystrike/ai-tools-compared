...
Spleeter's 5-stem model separates into vocals, drums, bass, piano, and other. If your primary target is piano-heavy music (jazz, classical), the 5-stem model provides cleaner results than the 4-stem variant. For pop and rock vocals, the 2-stem model is faster and sufficient.
