...
**Leverage incremental context.** Generate endpoints in batches. After creating product endpoints successfully, those become context for the next batch. The AI learns from its own output.
