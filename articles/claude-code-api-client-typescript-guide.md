...
- **This guide covers why**: typescript for claude code integration, setting up your typescript project, defining type-safe api types, with specific setup instructions
