...
description: "A practical look at voice interface support for Claude Code skills in 2026. Current capabilities, workarounds, and what to expect for voice-driven development workflows."
date: 2026-03-14
...
Claude skills are Markdown files stored in `~/.claude/skills/` that define instructions Claude follows during your session. When you type `/skillname`, Claude loads those instructions and applies them to your conversation. This design works entirely with text input and output.
