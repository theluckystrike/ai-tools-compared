...
- Order confirmation number (found in your receipt)
...
- **Your Pro features will be downgraded** to the free tier

- **You may lose access** to advanced AI features, higher limits, and other Pro-only functionality

- **Your code context** may still be preserved, but some features become unavailable
...
- **GitHub Copilot**: Tighter VS Code integration, broader IDE support including JetBrains and Neovim
- **Windsurf**: Stronger agentic task completion for multi-file refactors
- **JetBrains AI**: Best fit for Java, Kotlin, and IntelliJ-based workflows
...
- **Downgrade to a lower tier** — If available, switch to a cheaper plan

- **Pause your subscription** — Some services allow temporary pauses

- **Request a partial refund** — You may get a prorated refund for unused time

- **Provide feedback** — Sometimes support offers extensions or trial periods instead

- **Request account credit** — Cursor may offer account credit toward future billing instead of an immediate cash refund, which can be useful if you plan to resubscribe
