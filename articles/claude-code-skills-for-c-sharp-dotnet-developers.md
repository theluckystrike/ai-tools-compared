...
[The **xlsx** skill handles spreadsheet operations](/claude-skills-guide/claude-code-skills-for-real-estate-listing-platforms/) tracking metrics, test coverage, or sprint data.
...
[The **webapp-testing** skill helps verify frontend functionality](/claude-skills-guide/best-claude-skills-for-code-review-automation/) in ASP.NET Core applications.
...
- [What Is the Best Claude Skill for Automated Code Review](/claude-skills-guide/best-claude-skills-for-code-review-automation/) — add automated code review to your .NET development workflow
