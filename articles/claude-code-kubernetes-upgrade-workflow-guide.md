...
```bash
# Example: Determine upgrade path from 1.26 to 1.29
# 1.26 -> 1.27 -> 1.28 -> 1.29
```
...
```bash
# Example: Cordon and drain a node before upgrade
