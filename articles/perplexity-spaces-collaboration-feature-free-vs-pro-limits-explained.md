...
- Collaborative source collection and annotation

- Shared prompt templates and search configurations

- Team-wide knowledge base creation
...
- Invite 1 additional member per Space (2 members maximum)

- Conduct basic collaborative searches

- Share individual search results via link
...
- Up to 10 members per Space (scalable with team plans)

- 300 daily searches (enough for heavy collaborative use)

- 90-day conversation history retention

- 10GB storage per Space
...
| Maximum Spaces | 3 | Unlimited |

| Members per Space | 2 | 10+ |

| Daily Search Limit | 5 | 300 |

| Conversation History | 7 days | 90 days |

| Storage per Space | 100MB | 10GB |

| External Sharing | Limited | Full access |
...
- Research needs are occasional (less than 5 searches daily)

- Short-term collaboration meets your needs
...
- Daily research volume exceeds 5 searches

- Long-term knowledge base building is important

- External stakeholder collaboration is required
