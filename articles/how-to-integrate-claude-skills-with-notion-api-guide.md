...
- Meeting notes captured as PDFs → [`pdf` skill](/claude-skills-guide/articles/best-claude-skills-for-data-analysis/) extracts action items → Notion database entries created automatically
- Code reviews generated by [`tdd` skill](/claude-skills-guide/articles/best-claude-skills-for-developers-2026/) → stored in Notion as searchable documentation
- [`supermemory` skill](/claude-skills-guide/articles/claude-skills-token-optimization-reduce-api-costs/) can read from and write to Notion pages to maintain persistent project context
