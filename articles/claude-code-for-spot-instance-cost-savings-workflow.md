...
commands:
  ...
  - name: monitor-interruptions
    description: Monitor for spot interruption warnings and handle gracefully
  - name: analyze-cost-savings
    description: Calculate and report cost savings from spot usage
```
