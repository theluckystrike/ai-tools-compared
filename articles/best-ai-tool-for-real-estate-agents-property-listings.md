...
A practical workflow involves feeding the AI property details and specifying requirements:


```
Write a 150-word property description for a 3-bedroom,
2-bathroom home in suburban Phoenix. Highlight the backyard
pool, updated kitchen, and proximity to good schools.
Write in a friendly but professional tone suitable for
