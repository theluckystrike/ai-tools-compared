...
description: "Use Claude Code to refactor monolithic applications into microservices. Strategies, code patterns, and skill recommendations for successful architecture migration."
date: 2026-03-14
categories: [guides]
