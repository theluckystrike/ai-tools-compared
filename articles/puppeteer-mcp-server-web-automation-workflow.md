...
Before implementing automation workflows, you need to configure the Puppeteer MCP server in your Claude Code environment. The server requires Node.js 18 or higher and Puppeteer as a dependency.
...
Similarly, combining with the `tdd` skill allows you to write browser-based tests that verify UI behavior:
