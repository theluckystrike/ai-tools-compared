...
ChatGPT conversation starters are essentially quick-prompt templates. In Claude Projects, you can recreate these as reusable prompts. Create a `prompts/` folder with markdown files for each starter:
