...
Fast, integrated in editor, works with any framework, learns from your codebase.

Requires skeleton structure, generic suggestions, less context-aware than Claude.
...
High-quality generation, schema-aware, can handle complex relationships.

API dependency, latency (2-3s), cost per generation.
...
Fastest iteration, integrated with your editor, Claude-powered.

Subscription required, less flexible than manual prompting.

---

5. Specialized Tools: Factory Bot (Rails), Model Factories (Django)

AI doesn't generate these; instead, use factories + AI completion.
...
Requires setup, less flexible than custom scripts.
